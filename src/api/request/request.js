export const createFormData = (
    ...
    if (other_image) {
        data.append('other_image', other_image)
    }
    if (logo) {
    ...
    if (registryImage) {
        Object.keys(registryImage).forEach((value) => {
            data.append('registryImage', registryImage[value])
        })
    }
    if (health_files) {
    ...
    if (accessary_images) {
        Object.keys(accessary_images).forEach((value) => {
            data.append('accessary_images', accessary_images[value])
        })
    }
    if (insurance_photo) {
